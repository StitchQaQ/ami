...
const (
	...
	UserService_UpdateUserBehavior_FullMethodName   = "/user.UserService/UpdateUserBehavior"
	UserService_BatchGetUserProfiles_FullMethodName = "/user.UserService/BatchGetUserProfiles"
)
...
type UserServiceClient interface {
	...
	// 更新用户行为
	UpdateUserBehavior(ctx context.Context, in *UpdateUserBehaviorRequest, opts ...grpc.CallOption) (*UpdateUserBehaviorResponse, error)
	// 批量获取用户画像
...
func (c *userServiceClient) UpdateUserBehavior(ctx context.Context, in *UpdateUserBehaviorRequest, opts ...grpc.CallOption) (*UpdateUserBehaviorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateUserBehaviorResponse)
	err := c.cc.Invoke(ctx, UserService_UpdateUserBehavior_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// 更新用户行为
	UpdateUserBehavior(context.Context, *UpdateUserBehaviorRequest) (*UpdateUserBehaviorResponse, error)
	// 批量获取用户画像
...
func (UnimplementedUserServiceServer) UpdateUserBehavior(context.Context, *UpdateUserBehaviorRequest) (*UpdateUserBehaviorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUserBehavior not implemented")
}
...
func _UserService_UpdateUserBehavior_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateUserBehaviorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UpdateUserBehavior(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateUserBehavior_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateUserBehavior(ctx, req.(*UpdateUserBehaviorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateUserBehavior",
			Handler:    _UserService_UpdateUserBehavior_Handler,
		},
		{
